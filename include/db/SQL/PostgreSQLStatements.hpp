...
/**
 * @brief SQL statements for PostgreSQL database operations.
 *
 ...
 */
struct PostgreSQLStatements final {
    /**
...
CREATE TABLE IF NOT EXISTS recipe_ingredients (
    ...
    product_type_id BIGINT NOT NULL,
    required_amount_base BIGINT NOT NULL CHECK (required_amount_base > 0),
...
ORDER BY
     ...
     * @param[in] 1 Product type ID.
     */
    static constexpr std::string_view kSelectInventoryByProductTypeId =
        R"sql(
SELECT
    i.id,
    i.product_type_id,
...
ORDER BY
     ...
     */
    static constexpr std::string_view kSelectCookableRecipes = R"sql(
SELECT
    r.id,
    r.name,
    r.description
